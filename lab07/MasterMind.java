...
public class MasterMind implements Drawable
{
   ...
   public static void main(String[] args)
   {
      ...
      //use try-catch and catch two appropriate exceptions
        ...
        catch (ArrayIndexOutOfBoundsException it){
   ...
   public void setAI(int ai_int)
   {
      ...
      {
           current_ai = ais[(ai_int - 1)]; //array is 0-based
           
      }
        
        String out = "Using AI #" + ai_int + ": ";
        
        if (ai_int < 1 || ai_int > 3) out += "Human player.";
        if (ai_int == 1) out += "Random.";
        if (ai_int == 2) out += "Consistent.";
        if (ai_int == 3) out += "MiniMax.";
