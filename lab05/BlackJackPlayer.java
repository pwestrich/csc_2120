   ...
   public void split(Card card1, Card card2)
   {
      ...
      if (can_split) {
         //DO THIS
           ...
           //Split the hand in question
           BlackJackHand[] newHand = hands.get(hand_index - 1).split(card1, card2);
           
           //Remove the old one
           hands.remove(hand_index - 1);
           
           //Add the two new hands to the end of the list
           hands.add(newHand[0]);
           hands.add(newHand[1]);
