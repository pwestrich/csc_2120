...
public final class AVLTree extends BinarySearchTree
{
   ...
   public void delete(Comparable sk) throws TreeException
   {
     ...
     protected void checkInvariants(){
          ...
          assert super.validateSize() : "Size incorrect!";
          assert super.validateBSTProperty() : "Not a BST!";
          assert super.isBalanced() : "Not an AVL Tree!";
   ...
   protected TreeNode deleteLeftmost(TreeNode tNode) 
   {
     ...
     //double left-right roatation
     protected AVLTreeNode DLR(AVLTreeNode tNode){
     ...
     //double right-left roatation
     protected AVLTreeNode DRL(AVLTreeNode tNode){
