 ...
 *    @date   October 7, 2013
 *
 *   This is the class for jalapenos
 */

public final class BurritoCondimentJalapeno extends BurritoCondiment{
     ...
     public BurritoCondimentJalapeno(BurritoItem item){
     ...
     public boolean equals(BurritoCondiment bc){
          ...
          return (bc instanceof BurritoCondimentJalapeno);
