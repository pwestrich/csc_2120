...
{ 
   ...
   public void delete(Comparable searchKey) throws TreeException 
   {
     ...
     public TreeNode rotateRight(TreeNode root){ //Accepts tree to be rotated
          
          //Get the left and right nodes
          TreeNode left = root.getLeft();
          TreeNode right = root.getRight();
          
          //Left bedomes the new root
          TreeNode newRoot = left;
          
          //Re-arrange the subtrees
     ...
     public TreeNode rotateLeft(TreeNode root){ //Accepts tree to be rotated
