...
public class Students
{
   ...
   private int determineCurrentLabNumber()
   {
      ...
      for (Student current : students){
         ...
         if (currentLabID < current.getNumLabs()){
            
            currentLabID = current.getNumLabs();
   ...
   public String getStudentInfo(int studentID){
      ...
      return students.get(studentID - 1).getStudentInfo();
   ...
   public void setGrade(int studentID, int labID, char grade){
      ...
      if (partnerID > 0){
          students.get(partnerID - 1).setGrade(labID, grade);
        }
