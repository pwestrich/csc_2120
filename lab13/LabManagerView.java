...
public class LabManagerView extends CenterFrame
{
   ...
   private void processGrade()
   {
      ...
      int gradeID = cboGrades.getSelectedIndex();
      if (sectionID == 0 || labID == 0 || studentID == 0) { // added
        return;
      }
      char gradeChar = '\0';
      ...
      //Set grade
      sections.setGrade(sectionID, studentID, labID, gradeChar);
   ...
   private void fillTextBox()  
   {
      int studentID = cboStudents.getSelectedIndex() + 1;
      int sectionID = cboSections.getSelectedIndex() + 1;
      if (studentID == 0 || sectionID == 0) { // added
          return;
      }
