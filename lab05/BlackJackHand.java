...
public class BlackJackHand
{
    ...
    */
   public BlackJackHand(Card cardOne, Card cardTwo)
   {
      //remember to instantiate the ArrayList before adding anything to it
        ...
        if (cardOne.getFaceInt() == 1 || cardTwo.getFaceInt() == 1){
   ...
   public boolean canSplit()
   {
      ...
      if (hand.size() == 2)
      {
         //DO THIS
           ...
           if (hand.get(0).getFaceInt() == hand.get(1).getFaceInt()){
                
                split = true;
                
           }
           
           else if ((hand.get(0)).getFaceInt() >= 10 && (hand.get(1)).getFaceInt() >= 10){
